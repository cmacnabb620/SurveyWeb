...
<div id="content" class="span10">
  <ul class="breadcrumb">
    ...
    <li><a href="{{ url('admin/active_surveyors') }}">Surveyors</a></li>
    <i class="icon-angle-right"></i>
    <li><a href="{{ url('admin/add_project_managers') }}">Add Surveyors</a></li>
  </ul>
  <div class="row-fluid sortable">
    <div class="box span10">
      ...
      <div class="box-content">
        <form class="form-horizontal" action="{{url('admin/submit_surveyor_details')}}" method="POST" id="myform">
          ...
          <fieldset>
            <div class="span6">
              ...
              <div class="control-group">
                <label class="control-label" for="country"><b>Surveyor Type<span style="color:red">*</span></b></label>
                <div class="controls">
                  <select data-placeholder="" id="surveyor_type"  name="surveyor_type">
                    @foreach($surveyor_types as $surveyor_type)
                    <option value="{{$surveyor_type->user_type_id}}">{{$surveyor_type->user_type_desc}}</option>
                    @endforeach
                  </select>
                </div>
                </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="start_date" class="form-control datepicker" name="start_date" data-format="mm/dd/yyyy" placeholder="Enter Start Date" autocomplete="off">
                </div>
              </div>
...
// given the id of the <select> tag as function argument, it inserts <option> tags
  ...
  {
  var url   = "{{url('admin/submit_surveyor_details')}}";
  var csrf  = $('#_token').val();

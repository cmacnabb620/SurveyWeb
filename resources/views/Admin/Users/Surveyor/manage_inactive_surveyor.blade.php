...
<div id="content" class="span10">
	...
	<div class="row-fluid pm-buttons">
	    ...
	    <div class="span7">
			...
			<button class="btn btn-primary">Trainee Type ({{count($trainee_surveyors)}})</button>
			</a>
			...
			<button class="btn btn-success">Inactive Type ({{count($inactive_surveyors)}})</button>
			</a>
		</div>	
		<div class="span5">
	...
	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon white user"></i>&ensp;InActive Surveyors</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  ...
				  <tbody>
				  <?php $i=1; ?>
				@foreach($inactive_surveyors as $surveyor)
					<tr>
						<td>{{$i++}}</td>

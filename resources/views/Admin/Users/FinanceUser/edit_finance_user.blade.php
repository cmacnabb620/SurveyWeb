...
<div id="content" class="span10">
  <ul class="breadcrumb">
    ...
    <li><a href="{{ url('admin/project_managers') }}">Finance Users</a></li>
    <i class="icon-angle-right"></i>
    <li><a href="#">Edit Finance User(<b>{{ucfirst(\Crypt::decryptString($project_finance_user->first_name))}} {{ucfirst(\Crypt::decryptString($project_finance_user->last_name))}}</b>)</a></li>
  </ul>
  <div class="row-fluid sortable">
    <div class="box span10">
      <div class="box-header" data-original-title>
        ...
        <span> Edit Finance User</span></h2>
        <div class="box-icon">
      ...
      <div class="box-content">
        <form class="form-horizontal" action="{{url('admin/update_finance_user_details')}}" method="POST" id="myform">
          ...
          <fieldset>
            <div class="span6">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="form-control" id="fname" name="fname" value="{{\Crypt::decryptString($project_finance_user->first_name)}}"  placeholder="Enter First Name" maxlength="50">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>Last Name<span style="color:red">*</span></b></label>
                <div class="controls">
                  <input type="text" class="form-control" id="lname" name="lname" value="{{\Crypt::decryptString($project_finance_user->last_name)}}"  placeholder="Enter Last Name" maxlength="50">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>Email<span style="color:red">*</span></b></label>
                <div class="controls">
                  <input type="email" class="form-control" id="email" name="email" value="{{\Crypt::decryptString($project_finance_user->email)}}"  placeholder="Enter Email" maxlength="50" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>Phone Number<span style="color:red">*</span></b></label>
                <div class="controls">
                  <input type="text" class="form-control" id="phone" value="{{\Crypt::decryptString($project_finance_user->phone)}}" name="phone" placeholder="Enter Phone Number" maxlength="14" maxlength="14" onkeypress="return isNumberKey(event)"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><b>Date of Birth<span style="color:red">*</span></b></label>
                <div class="controls">
                  <input type="text" id="date" class="form-control datepicker" value="{{\Crypt::decryptString($project_finance_user->DOB)}}" name="date" data-format="mm/dd/yyyy" placeholder="Enter Date of Birth">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><b>Start Date<span style="color:red">*</span></b></label>
                <div class="controls">
                  <input type="text" id="start_date" class="form-control datepicker" name="start_date" value="{{ $project_finance_user->start_date }}" data-format="mm/dd/yyyy" placeholder="Enter Start Date">
                </div>
              </div>
              <!-- <div class="control-group">
            ...
            <div class="span6">
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  @foreach($user_types as $user_type)
                   <option value="{{$user_type->user_type_id}}" @if($user_type->user_type_id == $project_finance_user->user_type_id) selected="selected" @endif>{{$user_type->user_type_desc}}</option>
                  @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <select data-placeholder="Select State" id="state" name="state">
                    <option value="{{Crypt::decryptString($project_finance_user->state)}}" selected="selected">{{Crypt::decryptString($project_finance_user->state)}}</option>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="city" value="{{\Crypt::decryptString($project_finance_user->city)}}" class="form-control" id="city"  placeholder="Enter City" maxlength="50" >
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea rows="3" cols="50" name="address" id="address" placeholder="Address...">{{\Crypt::decryptString($project_finance_user->address)}}</textarea>
                </div>
              </div>
            </div>

...
<div id="content" class="span10">
  <ul class="breadcrumb">
    ...
    <i class="icon-angle-right"></i>
    <li><a href="#">Add Finance Users</a></li>
  </ul>
  <div class="row-fluid sortable">
    <div class="box span10">
      <div class="box-header" data-original-title>
        <h2>
        <i class="icon-user"></i>
        <span> Add Finance Users</span></h2>
        <div class="box-icon">
      ...
      <div class="box-content">
        <form class="form-horizontal" action="{{url('admin/submit_finance_user_details')}}" method="POST" id="myform">
...
// given the id of the <select> tag as function argument, it inserts <option> tags
  ...
  {
  var url   = "{{url('admin/submit_finance_user_details')}}";
  var csrf  = $('#_token').val();

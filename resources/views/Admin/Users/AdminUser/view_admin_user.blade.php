...
<div id="content" class="span10">
  <ul class="breadcrumb">
    ...
    <i class="icon-angle-right"></i>
    <li><a href="#">Admin User Details(<b>{{ucfirst(\Crypt::decryptString($admin_user->first_name))}} {{ucfirst(\Crypt::decryptString($admin_user->last_name))}}</b>)</a></li>
  </ul>
  <div class="row-fluid sortable">
    <div class="box span10">
      <div class="box-header" data-original-title>
        ...
        <span>Admin User Details</span></h2>
        <div class="box-icon">
          ...
          <fieldset>
            <div class="span6">
             <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="form-control" id="fname" name="fname" value="{{$admin_user->username}}"  placeholder="Enter First Name" maxlength="50" readonly="">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>First Name</b></label>
                <div class="controls">
                  <input type="text" class="form-control" id="fname" name="fname" value="{{\Crypt::decryptString($admin_user->first_name)}}"  placeholder="Enter First Name" maxlength="50" readonly="">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>Last Name</b></label>
                <div class="controls">
                  <input type="text" class="form-control" id="lname" name="lname" value="{{\Crypt::decryptString($admin_user->last_name)}}"  placeholder="Enter Last Name" maxlength="50" readonly="">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>Email</b></label>
                <div class="controls">
                  <input type="email" class="form-control" id="email" name="email" value="{{\Crypt::decryptString($admin_user->email)}}"  placeholder="Enter Email" maxlength="50" readonly=""/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="name"><b>Phone Number</b></label>
                <div class="controls">
                  <input type="text" class="form-control" id="phone" value="{{\Crypt::decryptString($admin_user->phone)}}" name="phone" placeholder="Enter Phone Number" maxlength="14" maxlength="14" readonly=""/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><b>Date of Birth</b></label>
                <div class="controls">
                  <input type="text"  class="form-control datepicker" value="{{\Crypt::decryptString($admin_user->DOB)}}" readonly="">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><b>Start Date</b></label>
                <div class="controls">
                  <input type="text" id="start_date" class="form-control datepicker" name="start_date" value="{{ $admin_user->start_date }}" data-format="mm/dd/yyyy" placeholder="Enter Start Date" readonly="">
                </div>
              </div>
              <!-- <div class="control-group">
            ...
            <div class="span6">
              <div class="control-group">
                ...
                <div class="controls">
                   <input type="text" id="date" class="form-control datepicker" value="{{\Crypt::decryptString($admin_user->country)}}" readonly="">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="state"><b>State</b></label>
                <div class="controls">
                   <input type="text" id="date" class="form-control datepicker" value="{{\Crypt::decryptString($admin_user->state)}}" readonly="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="city" value="{{\Crypt::decryptString($admin_user->city)}}" class="form-control" id="city"  placeholder="Enter City" maxlength="50" readonly="">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="address"><b>Address</b></label>
                <div class="controls">
                  <textarea rows="3" cols="50" name="address" id="address" placeholder="Address..." readonly="">{{\Crypt::decryptString($admin_user->address)}}</textarea>
                </div>
              </div>

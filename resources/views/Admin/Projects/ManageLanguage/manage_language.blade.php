...
<div id="content" class="span10">
	<ul class="breadcrumb">
		...
		<li><a href="{{url('admin/manage_language')}}">Manage Languages</a></li>
	</ul>
	
	<div class="row-fluid">
		<div class="statbox purple rolebox border-radius" onTablet="span8 offset2" onDesktop="span6 offset3">
			<!-- Create new role form start -->
			<form action="{{url('admin/add_new_language')}}" method="post">
				<input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
				<div class="formname">
					<div class="form-group span12">
						<label for="role-name" class="control-lable span4 lable-name"><b>Language Name</b></label>
						<input type="text" class="form-control span8 border-radius" name="language_name" value="{{old('language_name')}}" id="language_name" aria-describedby="language_name" placeholder="Enter language Name" maxlength="50">
					</div>

...
namespace App\Http\Controllers\ProjectManager\SettingManagement;
...
class ProjectManagerSettingController extends Controller {
    ...
    public function index(){
    	...
    	if(empty($user_id)){
            ...
            $project_manager_profile = User::join('user_type as usertype', 'usertype.user_type_id', '=', 'users.user_type_id')
        ...
        return view('ProjectManager.Settings.project_manager_settings',compact('project_manager_profile'));
    }
         ...
         return redirect()->back()->with('error','Something went wrong');
            ...
            if(!empty($user_profile)){
              if(!empty($file)){
                  ...
                  $file->move('crossroads/ProfilePics/ManagerPics', $newfilename);
                  // previous image delete code implement here.
                  
                  if(!empty($user_profile->profile_pic)){
                    File::delete('crossroads/ProfilePics/ManagerPics/'.$user_profile->profile_pic);

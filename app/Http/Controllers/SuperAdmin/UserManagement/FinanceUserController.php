...
class FinanceUserController extends Controller {
    ...
    public function index(){
    	$finance_users= \EnvatoUser::user_type_list(7);
    	/*dd($project_managers);*/
        return view('Admin.Users.FinanceUser.manage_finance_user',compact('finance_users'));
    }
   

   	public function addFinanceUser(){
        return view('Admin.Users.FinanceUser.add_finance_user');
    }
        ...
        if ($validator->fails())
        {
         return Response::json(array('success' => false,'errors' => $validator->getMessageBag()->toArray()), 400);
        	...
        	//tag_bridge table store start
        	 ...
        	 $tagbridge_table_store->tag_tag_id=7;
        	 ...
        	 $user_table_insert->user_type_id=7;
    ...
    public function viewDetails($userid){
        ...
        if(count($user_id) == 0){
            ...
            $project_finance_user= \EnvatoUser::edit_user($user_id,7);
            $user_types=UserType::all();
            return view('Admin/Users/FinanceUser/view_finance_user',compact('user_types','project_finance_user'));
        }
    }
    ...
    public function editDetails($userid){
        ...
        if(count($user_id) == 0){
            ...
            return view('Admin/Users/FinanceUser/edit_finance_user',compact('user_types','project_finance_user'));
        }
    }
    ...
    public function deleteFinanceUser($userid){
       $userid= Hashids::decode($userid);
        ...
        if(!empty($user_record)){
            ...
            return redirect()->to('/admin/finance_users')->with('message', 'Finance User Deleted Successfully');
            }catch (Exception $e) {

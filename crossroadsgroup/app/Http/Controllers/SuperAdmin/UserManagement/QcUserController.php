...
class QcUserController extends Controller {

    public function index(){
    	$qcusers= \EnvatoUser::user_type_list(6);
    	/*dd($project_managers);*/
        return view('Admin.Users.QcUser.manage_qc_user',compact('qcusers'));
    }
   

   	public function addQcUser(){
        return view('Admin.Users.QcUser.add_qc_user');
    }
        ...
        if ($validator->fails())
        {
         return Response::json(array('success' => false,'errors' => $validator->getMessageBag()->toArray()), 400);
        	...
        	//tag_bridge table store start
        	 ...
        	 $tagbridge_table_store->tag_tag_id=6;
        	 ...
        	 $user_table_insert->user_type_id=6;
    ...
    public function viewDetails($userid){
        ...
        if(count($user_id) == 0){
            ...
            $project_qc_user= \EnvatoUser::edit_user($user_id,6);
            $user_types=UserType::all();
            return view('Admin/Users/QcUser/view_qc_user',compact('user_types','project_qc_user'));
        }
    }
    ...
    public function editDetails($userid){
        ...
        if(count($user_id) == 0){
            ...
            return view('Admin/Users/QcUser/edit_qc_user',compact('user_types','project_qc_user'));
        }
    }
    ...
    public function deleteQcUser($userid){
       $userid= Hashids::decode($userid);
        ...
        if(!empty($user_record)){
            ...
            return redirect()->to('/admin/qc_users')->with('message', 'Qc-User Deleted Successfully');
            }catch (Exception $e) {

...
namespace App\Http\Controllers\SuperAdmin\SettingManagement;
...
class AdminSettingController extends Controller {
    ...
    public function index(){
    	...
    	if(empty($user_id)){
            ...
            $admin_profile = User::join('user_type as usertype', 'usertype.user_type_id', '=', 'users.user_type_id')
        ...
        return view('Admin.Settings.admin_settings',compact('admin_profile'));
    }
         ...
         return redirect()->back()->with('error','Something went wrong');
            ...
            if(!empty($user_profile)){
              if(!empty($file)){
                  ...
                  $file->move('crossroads/ProfilePics/AdminPics', $newfilename);
                  // previous image delete code implement here.
                  
                  if(!empty($user_profile->profile_pic)){
                    File::delete('crossroads/ProfilePics/AdminPics/'.$user_profile->profile_pic);

...
namespace App\Http\Controllers\QualityUser\SettingManagement;
...
class QcUserSettingController extends Controller {
    ...
    public function index(){
      ...
      if(empty($user_id)){
            ...
            $qc_user_profile = User::join('user_type as usertype', 'usertype.user_type_id', '=', 'users.user_type_id')
        ...
        return view('QualityUser.Settings.qc_user_settings',compact('qc_user_profile'));
    }
         ...
         return redirect()->back()->with('error','Something went wrong');
            ...
            if(!empty($user_profile)){
              if(!empty($file)){
                  ...
                  $file->move('crossroads/ProfilePics/QcPics', $newfilename);
                  // previous image delete code implement here.
                  
                  if(!empty($user_profile->profile_pic)){
                    File::delete('crossroads/ProfilePics/QcPics/'.$user_profile->profile_pic);
